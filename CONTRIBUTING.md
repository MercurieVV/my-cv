# Contributing to My CV

The My CV project welcomes contributions from anybody wishing to participate. All code or documentation that is provided must be licensed with the same license that My CV is licensed with (Apache 2.0, see [LICENSE](./LICENSE.md)).

## Code of Conduct

People are expected to follow the [Scala Code of Conduct](./CODE_OF_CONDUCT.md) when discussing My CV on the Github page, Gitter channel, or other venues.
...
```
Copyright (c) $today.year the My CV contributors.
See the project homepage at: https://MercurieVV.github.io/my-cv/
